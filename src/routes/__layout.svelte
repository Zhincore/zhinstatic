...
<div
  class="flex h-screen flex-col bg-zinc-100 text-zinc-900 transition-colors duration-300 dark:bg-zinc-900 dark:text-zinc-200"
>
  <div class="flex items-center px-1 lg:px-4 xl:px-8">
    <a
      href="."
